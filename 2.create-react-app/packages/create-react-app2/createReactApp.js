...
/**
 *
 * @param {*} root 创建的项目的路径 d/project/study/studyNotes/2.create-react-app/mycode/myApp
 * @param {*} appName 项目名 myApp
 * @param {*} originalDirectory 命令执行的工作目录  /d/project/study/studyNotes/2.create-react-app/mycode
 */
